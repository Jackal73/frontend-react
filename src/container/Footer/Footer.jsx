...
const Footer = () => {
  ...
  return (
    <>
      <h2 className="head-text">Take a coffee and <span>chat with me</span></h2>

      <div className="app__footer-cards">
        <div className="app__footer-card">
          <img src={images.email} alt="email" />
          <a href="mailto:shawn@kryptomix.digital" className="p-text">shawn@kryptomix.digital</a>
        </div>
        <div className="app__footer-card">
          <img src={images.mobile} alt="mobile" />
          <a href="cell: (618) 960-4809" className="p-text">(618) 960-4809</a>
        </div>
      </div>
